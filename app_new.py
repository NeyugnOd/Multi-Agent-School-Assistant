...
from src.workflows.agent_workflow import SchoolAssistantWorkflow
...
st.set_page_config(page_title="School Document Assistant", layout="wide")
...
def initialize_workflow(file_path: str):
    with st.spinner("🔄 Loading document and setting up the workflow..."):
        try:
            ...
            workflow = SchoolAssistantWorkflow(
                retriever=retriever,
...
with col1:
    st.markdown('''
        <h1 style='color: #2E86AB; margin-bottom: 10px;'>
            School Document AI Assistant
        </h1>
        <h3 style='color: #fff; margin-top: 0; margin-bottom: 16px;'>
            AI Assistant for internal school documents, policies and academic materials
        </h3>
...
st.markdown(
    ...
    "School Document AI Assistant • Built with Streamlit, CrewAI, Milvus, Firecrawl, and Ollama"
    "</p>",
    unsafe_allow_html=True
)
